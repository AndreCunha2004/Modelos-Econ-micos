...
plot(poluicao$dia, rstandard(Modelo_regressao), xlab = "dia", ylab = "Resíduos")
  abline(0,0)
  ...
  # bem como há valores a partir de um determinado nível da variável x que os dados se dispersam.
  
# Passo 7: aça uma predição de mpg para dia=121
